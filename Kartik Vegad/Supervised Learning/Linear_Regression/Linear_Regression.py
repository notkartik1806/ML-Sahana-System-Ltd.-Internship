...
DATASET_PATH = "Supervised Learning/Linear_Regression/medical_insurance.csv"
RANDOM_STATE = 42
TEST_SIZE = 0.2
VALIDATION_SIZE = 0.1
...
class DatasetVisualizer:
    ...
    def _plot_target_distribution(self) -> None:
       ...
       plt.tight_layout()
       plt.savefig('Supervised Learning\\Linear_Regression\\graphs\\target_distribution.png', dpi=DPI, bbox_inches='tight')
       plt.close()
    ...
    def _plot_correlation_heatmap(self) -> None:
       ...
       plt.tight_layout()
       plt.savefig('Supervised Learning\\Linear_Regression\\graphs\\correlation_heatmap.png', dpi=DPI, bbox_inches='tight')
       plt.close()
    ...
    def _plot_feature_distributions(self) -> None:
       ...
       plt.tight_layout()
       plt.savefig('Supervised Learning\\Linear_Regression\\graphs\\feature_distributions.png', dpi=DPI, bbox_inches='tight')
       plt.close()
    ...
    def _plot_top_correlations(self) -> None:
       ...
       plt.tight_layout()
       plt.savefig('Supervised Learning\\Linear_Regression\\graphs\\top_correlations.png', dpi=DPI, bbox_inches='tight')
       plt.close()
...
class LinearRegressionModel:
    """
    Custom Linear_Regression implementation using Gradient Descent.

    This class implements Linear_Regression from scratch with batch gradient
    ...
    def plot_loss_curve(self) -> None:
       ...
       plt.grid(True, alpha=0.3)
       plt.tight_layout()
       plt.savefig('Supervised Learning\\Linear_Regression\\graphs\\loss_curve.png', dpi=DPI, bbox_inches='tight')
       plt.close()
...
class ModelEvaluator:
    ...
    def _plot_predictions(
       ...
       plt.savefig(f'Supervised Learning\\Linear_Regression\\graphs\\{filename}', dpi=DPI, bbox_inches='tight')
       plt.close()
...
class MLPipeline:
    ...
    def run(self) -> None:
       ...
       print("\n" + "=" * 70)
       print("Linear_Regression PIPELINE - MEDICAL INSURANCE DATASET")
       print("=" * 70)
