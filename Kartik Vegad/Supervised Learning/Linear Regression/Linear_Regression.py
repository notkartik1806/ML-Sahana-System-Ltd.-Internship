...
class DatasetVisualizer:
    ...
    def _plot_target_distribution(self) -> None:
       ...
       plt.tight_layout()
       plt.savefig('Supervised Learning/Linear Regression/graphs/target_distribution.png',
    ...
    def _plot_correlation_heatmap(self) -> None:
       ...
       plt.tight_layout()
       plt.savefig('Supervised Learning/Linear Regression/graphs/correlation_heatmap.png',
                   dpi=DPI, bbox_inches='tight')
       plt.close()
    ...
    def _plot_feature_distributions(self) -> None:
       ...
       plt.tight_layout()
       plt.savefig('Supervised Learning/Linear Regression/graphs/feature_distributions.png',
                   dpi=DPI, bbox_inches='tight')
       plt.close()
    ...
    def _plot_feature_boxplots(self) -> None:
       ...
       plt.tight_layout()
       plt.savefig('Supervised Learning/Linear Regression/graphs/feature_boxplots.png',
                   dpi=DPI, bbox_inches='tight')
       plt.close()
...
class LogisticRegressionModel:
    ...
    def plot_loss_curve(self) -> None:
       ...
       plt.grid(True, alpha=0.3)
       plt.tight_layout()
       plt.savefig('Supervised Learning/Linear Regression/graphs/loss_curve.png',
                   dpi=DPI, bbox_inches='tight')
       plt.close()
